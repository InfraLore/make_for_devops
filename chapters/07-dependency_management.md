...
config/$(ENVIRONMENT).env: config/$(ENVIRONMENT).env.template
	@echo "⚠️  Configuration template updated. Please review config/$(ENVIRONMENT).env"
...
deploy-optional-components:
	...
	@$(MAKE) deploy-monitoring || echo "⚠️ Monitoring deployment failed, continuing..."
	@$(MAKE) deploy-analytics || echo "⚠️ Analytics deployment failed, continuing..."
	@$(MAKE) deploy-logging || echo "⚠️ Logging deployment failed, continuing..."
